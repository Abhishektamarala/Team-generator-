let display_teams = function(mn,attempt_index)
{
    ...
    obj.attempts.forEach((attempt,index)=>
    {
       ...
       {
           display_teams_helper(attempt.team_list)
       }
    })
}
let display_teams_helper = function(team_list)
{
    team_placer = document.getElementById('team_placer')
    team_list.forEach((team)=>
    {
        created_team = get_11_memebers(team)
        team_placer.appendChild(created_team)
    })
}
let get_11_memebers = function(team)
{
    ...
    return final_team_creation(wk,bat,al,bowl,team.captain,team.vice_captain,team.team_number,team.team_credits,0)
}

let final_team_creation = function(wk,bat,al,bowl,captain,vice_captain,team_number,credits,vp)
{
    ...
    wk.forEach((player)=>
    {
        ...
        if(player.player_image==captain)
        {
        ...
        else if(player.player_image==vice_captain)
        {
            span_ele = document.createElement('span')
