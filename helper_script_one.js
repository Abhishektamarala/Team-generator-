let select_players = function(team1,team2,mn)
{
...
submit_players.addEventListener('click',()=>
{
    ...
    get_fixed_players(team1,team2,index_one,index_two)
    ...
    sfp.addEventListener('click',()=>
    {
            ...
            if(fixed_cnt>7){raiseError('you cannont select more than 7');return}
            fp = document.getElementById('fixed_player')
            fp.style.display="none"
            get_captain_players(team1,team2,index_one,index_two)
            ...
            scp.addEventListener('click',()=>
            {
                ...
                cp.style.display="none"
                // start the vice
                get_vice_captain_players(team1,team2,index_one,index_two)
                ...
                svcp.addEventListener('click',()=>
                {
                    ...
                    crc.addEventListener('click',()=>
                    {
                        ...
                        team_generator(index_one,index_two,team1,team2,mn,csv,cev,fixed_team_one_players,fixed_team_two_players,captain_team_one_players,captain_team_two_players,vice_captain_team_one_players,vice_captain_team_two_players)
                    })
                })
